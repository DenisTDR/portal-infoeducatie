    ...
    public class FinalXlsxExportServiceWithCeilings
    {
        ...
        public async Task<XLWorkbook> BuildWorkbookForCategory(CategoryEntity category)
        {
            ...
            foreach (var judge in judges)
            {
                ...
                sheetTitle = sheetTitle.Substring(0, Math.Min(sheetTitle.Length, 31));
                BuildIndividualTallySheet(workbook.Worksheets.Add(sheetTitle), judge, openProjects, openCriteriaSections,
            ...
            BuildFinalTallySheet(workbook.Worksheets.Add("Borderou final OPEN"), judges, openProjects, openGivenPoints,
                category, true);
